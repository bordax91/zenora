...
import Header from '@/components/Header' // <-- Ajout de l'import

export default function Home() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-white flex flex-col">
      <Header /> {/* <-- Utilisation du vrai header */}
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
          ...
          <div className="space-y-6">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Link
                href="/chat"
                className="bg-blue-600 text-white text-center font-semibold py-3 px-6 rounded-lg shadow hover:bg-blue-700 transition"
              >
                🧠 Discuter gratuitement avec notre IA spécialisée
              </Link>
              <Link
                href="/coach"
                className="bg-white text-blue-700 text-center font-semibold py-3 px-6 rounded-lg shadow border hover:bg-blue-50 transition"
              >
